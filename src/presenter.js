...
form.addEventListener("submit", (event) => {
    ...
    const total = ventas.precioTotal(neto, impuesto, descuento);
    const porcentaje = ventas.porcentajeDescuento(neto, impuesto);
    const totalNetoImpuesto = ventas.totalNetoImpuesto(neto, impuesto);
    ...
    div.innerHTML += "<p> Precio con impuesto: " + totalNetoImpuesto + " $</p>";
